...
int main()
{
    ...
    /*
     * SGPIO SPI0 wiring is fixed in sgpio_slave.h:
     *   SGPIO SCLK      -> M032 PA2 SPI0_CLK input
     *   SGPIO SDATA OUT -> M032 PA0 SPI0_MOSI input
     *   SGPIO SLOAD     -> M032 PA3 SPI0_SS input
     */
    SGPIO_Init();
